...
if __name__ == '__main__':
	...
	viz = Visdom(env='G5 TumorNet-Dice cascade frozen-MapNet-MapDice')
	...
	config_splitData = {
		...
		'savedmap_path': "/data/lihuiyu/LiTS/Preprocessed_S3_W20040_48/Inverse/",
		'TVTcsv' : './G5TVTcsv',
		'valid_csv' : './valid.csv',
		'episode' : 1,
		'ratio' : 0.9
	...
	config = {
		...
		'weight_decay' : 0,
		'train_csv_list': ['./G5TVTcsv/train' + str(i) + '.csv' for i in range(episode)],
		'valid_csv': './G5TVTcsv/valid.csv',
		'test_csv': './test.csv',
	...
	from MapNet import MapNet, MapDice, MapDiceLoss
