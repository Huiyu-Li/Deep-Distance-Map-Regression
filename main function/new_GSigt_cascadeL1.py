...
if __name__ == '__main__':
	...
	viz = Visdom(env='Gt TumorNet cascade frozen-MapNet-SmoothL1 tumor')
	...
	config = {
		...
		'weight_decay' : 0,
		'train_csv_list': ['./G4TVTcsv/train' + str(i) + '.csv' for i in range(episode)],
		'valid_csv': './G4TVTcsv/valid.csv',
		'test_csv': './test.csv',
		# below is the saved path
		'ckpt_dir': './G00results/',
		'saved_dir': "/data/lihuiyu/LiTS/Valid_results/check822sigmoidL10/",
        'model_dir': "/home/lihuiyu/Code/LiTS_TumorNet_Map/G00results/20200220-115838/model_1-0-0003.pth",
        ...
        'tail_dir': "/home/lihuiyu/Code/LiTS_TumorNet_Map/G00results/20200220-115838/tail_1-0-6094.pth"
            #"/home/lihuiyu/Code/LiTS_TumorNet_Map/STOATumorMapNet/NormInverseMapNet/20200129-130035sigmoid/model_196-0-9775.pth"
